...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		{
			# file_put_contents("data_table.txt", isset($_POST["search"]["value"]));
			$query .= '
		...
		# file_put_contents("data_table.txt", $_POST['order']['0'], FILE_APPEND);
		# file_put_contents("data_table.txt", $query, FILE_APPEND);
	...
	{
		$query = "
		SELECT tbl_student.student_name, tbl_student.student_roll_number, tbl_grade.grade_name, tbl_student.student_id FROM tbl_attendance 
		INNER JOIN tbl_student 
		ON tbl_student.student_id = tbl_attendance.student_id 
		INNER JOIN tbl_grade 
		ON tbl_grade.grade_id = tbl_student.student_grade_id 
